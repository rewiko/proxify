<template>
  <aside data-cy="aside-menu" class="aside-menu">
    <b-tabs>
      <b-tab title="<i class='fa fa-list'></i>">
        ...
        <Callout variant="info" class="m-0 py-3">
          ...
          <small class="text-muted"><i class="fa fa-skype"></i>&nbsp; On-line </small>
        </Callout>
        <hr class="transparent mx-3 my-0">
        <Callout class="m-0 py-2 text-muted text-center bg-light text-uppercase">
      ...
      <b-tab title="<i class='fa fa-comment'></i>">
        <div class="p-3">
          <div class="message">
      ...
      <b-tab title="<i class='fa fa-cogs'></i>">
        <div class="p-3">
          <h6>Settings</h6>
